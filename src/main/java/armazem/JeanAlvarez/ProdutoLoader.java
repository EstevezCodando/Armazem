...
public class ProdutoLoader implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) throws Exception {
		...
		Fornecedor fornecedor = new Fornecedor("F001", "Distribuidora de Bebidas S.A.", "12.345.678/0001-99",
				"Distribuidora X", "Distri X", "1234-5678", null);

		fornecedorService.incluir(fornecedor);

		Produto produto1 = new Produto("P001", "Cachaça 51", "Müller", "985 ml", "Cachaça brasileira popular",
				alcoolicas, "7896541239876", 12.00, 20.00, 100, Collections.singletonList(fornecedor), null);
		Produto produto2 = new Produto("P002", "Vodka Absolut", "Absolut", "750 ml", "Vodka sueca", alcoolicas,
				"7896541239999", 30.00, 45.00, 50, Collections.singletonList(fornecedor), null);
